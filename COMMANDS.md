...
| – | `/flow` | Any time / *understanding* | As needed | Anyone | agent or type | Draw the flow as a diagram (a story, a change, or the repo architecture) to build a mental model; offered softly at `/align` + onboarding | a mermaid diagram |
