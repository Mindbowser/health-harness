#!/bin/sh
# Fleet script — Ubuntu / Linux (and WSL). Writes Claude Code managed-settings.json
# so the health-harness plugin is registered, enabled, and auto-updates for everyone.
